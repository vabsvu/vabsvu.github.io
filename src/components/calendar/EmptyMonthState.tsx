  ...
  return (
    <div className="flex flex-col items-center text-center pt-10 pb-6 px-4">
      <CalendarDays
        ...
        aria-hidden="true"
      />
      <p className="text-almond/70 font-quattrocento text-lg">
      ...
      <a
        ...
        className="mt-2 inline-flex items-center justify-center gap-1.5 text-gold-light hover:text-spanish text-sm font-quattrocento transition-colors"
      >
      ...
      {hasUpcoming && (
        <button
          ...
          className="mt-4 inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-quattrocento font-bold text-gold-light border border-gold/30 bg-gold/10 hover:bg-gold/20 transition-colors"
        >
          Jump to next event
